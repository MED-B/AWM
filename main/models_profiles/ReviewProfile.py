...
class ReviewAdmin(admin.ModelAdmin): 
    list_display = ['productName','shipping_rating','productquality_rating','salesservices_rating']
    ...
    list_filter = ['productid__productname','shipping_rating','productquality_rating','salesservices_rating']
